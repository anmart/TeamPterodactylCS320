...
<<<<<<< HEAD
	...
	public View(){
		...
		try {
			...
			String url = "jdbc:h2:~\\workspace\\TeamPterodactylCS320\\test";
	...
	public int LibrarianLogin(){
		...
		int inputInt;
		try{
			inputInt = reader.nextInt();reader.nextLine();//to clear newline character
	...
	public void addItem(){
		try{//using a massive try since we have to enter so many numbers throughout this function
			...
			try {
				...
				// TODO Auto-generated catch block
				System.out.println("Something went wrong, maybe this item already exists? Quitting.");
			}
...
>>>>>>> 3d273b9a27bed367adf642dc0aba80d1fd8ec997
...
<<<<<<< HEAD
	...
	public void clearScreen(boolean prompt){
		...
		// this is such a dirty hack. but there's no real windows support for clearing the screen, and nothing os independent
		for (int i=0; i<25; i++)
			System.out.println();
